package com.example.shop.order.services.orderItemService.impl;
...
import com.example.shop.order.persistence.repositories.OrderItemRepository;
...
public class OrderItemServiceImpl implements OrderItemService {
  ...
  public OrderItemDto create(OrderItemDto orderItemDto) {
    ...
    return mapToDto(
        orderItemRepository.save(new OrderItem(orderItemDto.getQuantity(), orderItemDto.getProductId(), order)));
  }
